...
import _ui from './app/ui';
// import _navi from './app/navigator';
import _solarSystem from './app/solarSystem';
import _user from './app/user';
// import overthrow from './lib/overthrow';
// import RequestAnimationFrame from './lib/RequestAnimationFrame';

export default import(/* webpackChunkName: "shared" */ './app/shared').then(({ default: _s }) =>{
	...
	function Init () {
		...
		async function InitInternal () {
			...
			var { default: _navi} = await import(/* webpackChunkName: "navigator" */ './app/navigator');
