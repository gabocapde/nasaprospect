...
export default import(/* webpackChunkName: "utilities" */ './utilities').then(({ default: _utils }) =>{
	console.log('-----_utils1--', _utils);

	return import(/* webpackChunkName: "navigator" */ './navigator').then(({ default: _navi }) =>{
		return import(/* webpackChunkName: "shared" */ './shared').then(({ default: _s }) =>{
			...
			_$characters.each( function () {
				...
				if ( typeof id === 'string' ) {
					...
					$character.imagesLoaded( function () {
							...
							console.log('-----_utils--', _utils);
							console.log('-----_s--', _s);
							console.log('-----_navi--', _navi);
